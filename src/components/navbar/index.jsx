...
function NavbarComponents() {
  ...
  return (
    <div className='bg-darkPurple pt-1 md:pt-2 md:pb-1 xl:pr-2'>
      {/* Navbar */}
      <nav className="relative container mx-auto p-3 bg-darkPurple lg:p-1">
        {/* flex Container */}
        <div className="flex  items-center justify-between  ">
          {/* Logo */}
          <div className="pt-2 flex items-center space-x-2 h-fit lg:space-x-3 xl:space-x-5 ">
          ...
          <div className=" flex space-x-1   mt-2 lg:space-x-3">
            <Button variant='contained' sx={{ width: {md:'9px'}, fontSize: '7px', height: '25px', backgroundColor: "white", '&:hover,&.Mui-active': { backgroundColor: "#ffdfff" }, color: "black" }} className=''>Sign Up</Button>
