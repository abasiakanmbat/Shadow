  ...
  return (
    <div>
      <div className="  h-[95px] bg-fuchsia-900 grid items-center  ">
        <Navbar fluid rounded className='bg-0 text-white z-10'>
          ...
          <div className="flex md:order-2 space-x-2">
            <Button variant ='contained' sx={{backgroundColor:"white",'&:hover,&.Mui-active':{backgroundColor:"white"},  color:"black"}}   className='Button subtn'>Sign Up</Button>
            {/* <Button variant="contained">Hello world</Button>; */}
            {/* <Button color='light' className='text-fuchsia-900'>Login</Button> */}
            <Navbar.Toggle />
          </div>
          <div className='xl:-translate-x-10 flex' >
            ...
            <input className='pl-10 focus:outline-none placeholder:italic placeholder:text-slate-400 xl:w-[400px] rounded-[5px] h-8 text-black' placeholder='search' type="search" name="" id="" />
          </div>
